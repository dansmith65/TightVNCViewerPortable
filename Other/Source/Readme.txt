...
user in an INI file next to TightVNCViewerPortable.exe called TightVNCViewerPortable.ini.
...
copy AppNamePortable.ini from this directory to TightVNCViewerPortable.ini next to
TightVNCViewerPortable.exe. The options in the INI file are as follows:
